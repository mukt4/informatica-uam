...
def get_image_paths(data_path, categories, num_train_per_cat, num_test_per_cat):
    ...
    train_labels_indices = [None] * (num_categories * num_train_per_cat)
    test_labels_indices = [None] * (num_categories * num_test_per_cat)
    for i, cat in enumerate(categories):
        ...
        for j in range(num_test_per_cat):
            ...
            test_labels_indices[i * num_test_per_cat + j] = i
...
def get_accuracy(etiquetas, categorias_predichas):
    ...
    print("Etiquetas a predecir: ")
    print(etiquetas)
    print("Etiquetas predichas: ")
    print(categorias_predichas)
    print("Se han predecido correctamente: " + str(correct) + " de un total de " + str(total) + " imagenes.")
