...
HD_PWD='/home/alumnos/e359327/DIE/P3/P3a/static_timing/static_timing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux2_8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux2_8.tcl -notrace
