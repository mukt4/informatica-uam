...
HD_PWD='/home/alumnos/e359327/DIE/P3/P3a/static_timing/static_timing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux2_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux2_8.tcl
