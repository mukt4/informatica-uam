...
int main(int argc, char** argv)
{
  ...
  pdicc = ini_diccionario(tamanio,ORDENADO);        /*CAMBIAR ENTRE ORDENADO Y DESORDENADO DEPENDIENDO DEL ALGORTIMO DE BUSQUEDA*/
  ...
  nob = busca_diccionario(pdicc,clave,&pos,bbin);     /*CAMBIAR ALGORITMOS DE BUSQUEDA, SI ES BBIN TIENE QUE ESTAR TABLA ORDENADA*/
