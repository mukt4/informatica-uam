(defpackage :2363_P08_968b5 ; se declara un paquete con el grupo, la pareja y
							; el código
...
(in-package 2363_P08_968b5)

(defvar *alias* '|CR7HatTrycks|) ; alias que aparece en el ranking
